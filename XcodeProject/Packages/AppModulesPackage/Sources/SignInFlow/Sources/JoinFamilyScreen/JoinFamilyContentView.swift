...
extension JoinFamilyViewController {
    ...
    final class ContentView: BaseView {
        ...
        private(set) lazy var joinFamilyButton: ActionButton = {
            
            var filled = UIButton.Configuration.filled()
            filled.title = "Join family"
        ...
        private(set) lazy var enterFamilyNameTitle: UILabel = {
            let label = UILabel()
            label.text = "Enter the invitation code"
        ...
        private(set) var codeInputField: TextFieldWithInsets = {
        ...
        override func setLayout() {
            ...
            stack.addArrangedSubview(codeInputField)
            stack.addArrangedSubview(joinFamilyButton)
